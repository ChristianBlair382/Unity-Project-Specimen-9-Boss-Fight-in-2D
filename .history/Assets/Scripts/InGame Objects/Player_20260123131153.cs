...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private float STM = 100f;private float Horizontal_SPD = 4f;
    private float Vertical_SPD = 8f;
    private float HPRegenTimer = 0.0f;
    private float STMRegenTimer = 0.0f;
    private float HPRegenRate = 2f;
    private float STMRegenRate = 5f;
