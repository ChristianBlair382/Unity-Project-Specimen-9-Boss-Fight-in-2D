...
public class Specimen_9 : MonoBehaviour
{
    ...
    private void PerformAttackSequence()
    {
        ...
        if (currentState == InteractionState.Waiting)
        {
            ...
            //stateTimer = attackDuration; // Duration of attack phase
    ...
    public void Stun()
    {
        ...
        currentWellnesswellnessState = WellnessState.Vulnerable;
    ...
    private IEnumerator StunTransition(float duration)
    {
        ...
        Vector3 targetPos = new Vector3(transform.position.x, -.99f, transform.position.z);
