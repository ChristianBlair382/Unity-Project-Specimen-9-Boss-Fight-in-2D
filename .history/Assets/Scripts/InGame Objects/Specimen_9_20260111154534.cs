...
public class Specimen_9 : MonoBehaviour
{
    ...
    {
        //Upon being stunned, Specimen 9 will lerp lower to the ground for a brief moment
        float originalY = transform.position.y;
        Vector3 loweredPosition = new Vector3(transform.position.x, originalY - 1.0f, transform.position.z);
