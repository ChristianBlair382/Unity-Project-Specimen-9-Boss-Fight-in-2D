...
public class CeilingProjectile : MonoBehaviour
{
    ...
    public IEnumerator StallBeforeFall()
    {
        ...
        dangerZoneInstance = Instantiate(dangerZonePrefab, new Vector3(transform.position.x, 3.5f, -2.1f), Quaternion.identity);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            Instantiate(explosionPrefab, new Vector3(transform.position.x,, Quaternion.identity);
            Destroy(gameObject);
        }
    }
}
