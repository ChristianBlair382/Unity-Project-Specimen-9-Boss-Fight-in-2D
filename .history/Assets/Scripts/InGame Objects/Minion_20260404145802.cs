...
public class Minion : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ParticleEffectOrientationTransform = new Vector3(transform.position.x + Random.Range(-0.25f, 0.25f), transform.position.y + Random.Range(-0.5f, 0.5f), transform.position.z - 1.0f);
    }
    // Minion Methods
