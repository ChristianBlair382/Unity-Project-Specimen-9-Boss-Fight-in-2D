...
public class Player : MonoBehaviour
{
    ...
    private void AxeAttack()
    {
        ...
        foreach(Collider2D enemyGameObject in enemy)
        {
            ...
            {
                StartCoroutine(SpawnParticleEffectOnObject(slashParticleEffectPrefab, new Vector3(enemyGameObject.transform.position.x, enemyGameObject.transform.position.y, enemyGameObject.transform.position.z - 1.0f)));
