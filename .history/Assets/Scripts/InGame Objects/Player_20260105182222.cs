...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private float iFrameTimer = 1.0f;
    ...
    private void Awake()
    {
        ...
        physicalCollider = colliders[0] as BoxCollider2D;
    ...
    private void AxeAttack()
    {
        ...
        foreach(Collider2D enemyGameObject in enemy)
        {
            ...
            } else if (enemyGameObject.tag == "Specimen_9"enemyGameObject.tag == "VolleyOrb")
            {
                enemyGameObject.GetComponent<Specimen_9>().TakeDamage(20);
            }
        }
    }
    // Other Methods
    ...
    {
        this.gameObject.layer = LayerMask.NameToLayer("Intangible");
