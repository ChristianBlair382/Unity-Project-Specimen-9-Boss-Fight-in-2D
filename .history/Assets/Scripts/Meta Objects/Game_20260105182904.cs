...
public class Game : MonoBehaviour
{
    ...
    [SerializeField] private float playerSpawnX, playerSpawnY;
    ...
    void Update()
    {
        ...
        {
            Instantiate(volleyOrbPrefab, new Vector3(10, playerCharacter.transform.position.y, 0), Quaternion.identity);
        }
    ...
    {
        playerCharacter = Instantiate(playerCharacterPrefab, new Vector3(playerSpawnX, playerSpawnY, 0), Quaternion.identity);
