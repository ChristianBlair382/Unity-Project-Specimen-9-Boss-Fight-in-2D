...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Handle Attacking
        if(Input.GetB && (interactionState != PlayerInteractionState.Attacking || interactionState != PlayerInteractionState.Jumping) && physicalState == PlayerPhysicalState.Grounded)
        {
