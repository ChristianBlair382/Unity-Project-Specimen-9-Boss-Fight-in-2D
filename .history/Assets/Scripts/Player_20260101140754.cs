...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Handle Attacking
        if(Input.GetMouseButtonDown(0) && (interactionState != PlayerInteractionState.Attacking || interactionState != PlayerInteractionState.Attacking) && physicalState == PlayerPhysicalState.Grounded)
        {
