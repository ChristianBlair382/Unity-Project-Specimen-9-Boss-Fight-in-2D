...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(Input.GetButtonDown("Jump") && interactionState != PlayerInteractionState.Jumping)
        {
        ...
        // Handle Attacking
        if(Input.GetMouseButtonDown(0) && interactionState != PlayerInteractionState.Attacking && )
        {
